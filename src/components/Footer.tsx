          ...
          <div>
            ...
            <div className={styles.contactDetails}>
              <div className={styles.contactItem}>
                ...
                >
                  Varde Valaulikar Rd, Margao, Goa 403601 <br />
              ...
              <div className={styles.contactItem}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                  <a href="tel:+919823289069" className={styles.footerPhoneLink}>+91 98232 89069</a>
                  <a href="tel:+919422438353" className={styles.footerPhoneLink}>+91 94224 38353</a>
                </div>
              </div>
            </div>
          </div>
