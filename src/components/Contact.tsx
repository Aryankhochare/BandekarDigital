...
export default function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const whatsappNumber = process.env.NEXT_PUBLIC_WHATSAPP_NUMBER || "918356906948";
        ...
        <div className={styles.contactGrid}>
          ...
          <div className={styles.contactInfo}>
            ...
            <div className={styles.cardsWrapper}>
              {/* Phone Card */}
              <a href="tel:+918356906948" className={styles.infoCard} style={{ textDecoration: 'none', color: 'inherit' }}>
                ...
                <div>
                  ...
                  <p className={styles.cardValue}>+91 83569 06948</p>
                </div>
              </a>

              {/* WhatsApp Card */}
              <a href="https://wa.me/918356906948" target="_blank" rel="noopener noreferrer" className={styles.infoCard} style={{ textDecoration: 'none', color: 'inherit' }}>
              ...
              <div className={styles.infoCard}>
                ...
                <div>
                  ...
                  <p className={styles.cardValue}>info@bandekarsdigital.com</p>
                </div>
              </div>
              ...
              <div className={styles.infoCard}>
                ...
                <div>
                  ...
                  <p className={styles.cardValue}>Varde Valaulikar Rd, Pajifond, Madgaon, Goa 403601</p>
                </div>
              </div>
